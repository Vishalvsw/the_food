...
export const TrashIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.134-2.036-2.134H8.716C7.58 2.134 6.67 3.084 6.67 4.2v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
    </svg>
);
...
export const UsersIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-1.023-.19-2.057-1.414-2.057a4.5 4.5 0 00-4.474 2.582m11.148 3.168a4.5 4.5 0 00-5.216-1.642m5.216 1.642a4.5 4.5 0 01-5.216-1.642m0 0a4.5 4.5 0 01-5.216 1.642m5.216-1.642L12 18.5m0 0L8.684 15.168m3.316 3.332a4.5 4.5 0 01-5.216-1.642" />
    </svg>
);

export const SpinnerIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.691V5.25a3.375 3.375 0 00-3.375-3.375H8.25a3.375 3.375 0 00-3.375 3.375v4.992" />
    </svg>
);
...
export const InstagramIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.024.06 1.378.06 3.808s-.012 2.784-.06 3.808c-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.024.048-1.378.06-3.808.06s-2.784-.012-3.808-.06c-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.048-1.024-.06-1.378-.06-3.808s.012-2.784.06-3.808c.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 016.345 2.525c.636-.247 1.363-.416 2.427-.465C9.793 2.013 10.147 2 12.315 2zm-1.161 1.043c-1.06.048-1.694.21-2.227.427-.636.254-1.055.59-1.48.995-.425.405-.77.84-1.015 1.48-.217.533-.378 1.168-.426 2.227-.048 1.025-.06 1.352-.06 3.659s.012 2.634.06 3.659c.048 1.06.21 1.694.427 2.227.247.636.59 1.055.995 1.48.405.425.84.77 1.48 1.015.533.217 1.168.378 2.227.426 1.025.048 1.352.06 3.659.06s2.634-.012 3.659-.06c1.06-.048 1.694-.21 2.227-.427.636-.254 1.055.59 1.48-.995.425-.405.77-.84 1.015-1.48.217-.533.378-1.168-.426-2.227.048-1.025.06-1.352.06-3.659s-.012-2.634-.06-3.659c-.048-1.06-.21-1.694-.427-2.227-.247-.636-.59-1.055-.995-1.48-.405-.425-.84-.77-1.48-1.015-.533-.217-1.168-.378-2.227-.426-1.025-.048-1.352-.06-3.659-.06s-2.634.012-3.659.06zM12 6.865a5.135 5.135 0 100 10.27 5.135 5.135 0 000-10.27zm0 1.043a4.092 4.092 0 110 8.184 4.092 4.092 0 010-8.184zM17.25 5.5a1.25 1.25 0 100 2.5 1.25 1.25 0 000-2.5z" clipRule="evenodd" />
    </svg>
);
...
export const ShoppingCartIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.328 1.093-.824l3.12-6.24A.968.968 0 0018.618 6H4.634a1 1 0 00-.943.684l-1.38 5.52H3c-1.105 0-2 .895-2 2v1c0 1.105.895 2 2 2h1.5a4.5 4.5 0 004.5 4.5h6a4.5 4.5 0 004.5-4.5h1.5a.75.75 0 000-1.5H5.818a1.5 1.5 0 01-1.44-1.072L3.134 6.166M7.5 14.25v5.25m8.25-5.25v5.25" />
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg className={className} viewBox="0 0 48 48">
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C41.38,36.141,44,30.63,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
    </svg>
);

export const AppleIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M15.226,15.221c0.843-0.975,1.442-2.31,1.442-3.832c0-2.34-1.637-3.929-3.987-3.929c-1.12,0-2.302,0.595-3.144,0.595 c-0.812,0-1.859-0.54-3.033-0.54c-2.457,0-4.38,1.88-4.38,4.537c0,2.949,2.48,6.17,4.9,6.17c0.943,0,1.886-0.626,2.83-0.626 c0.912,0,1.744,0.626,2.887,0.626C14.889,18.221,15.226,15.221,15.226,15.221z M12.593,6.136c0.75-0.898,1.269-2.072,1.139-3.18 c-1.018,0.063-2.18,0.689-2.93,1.587C10.05,5.44,9.5,6.643,9.66,7.752C10.743,7.752,11.842,6.973,12.593,6.136z"></path>
    </svg>
);
...
export const TicketIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-1.5h5.25m-5.25 0h5.25m-5.25 0h5.25m-5.25 0h5.25M3 13.5a3 3 0 116 0v-3a3 3 0 11-6 0v3zm12-3a3 3 0 116 0v-3a3 3 0 11-6 0v3z" />
    </svg>
);

export const ChatBubbleOvalLeftEllipsisIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.388m-5.34-4.437a2.561 2.561 0 01-.01-3.655 2.56 2.56 0 013.655-.01l3.45 3.45a.75.75 0 001.06 0l3.45-3.45a2.56 2.56 0 013.656.011 2.56 2.56 0 01.01 3.655L12 21.56l-5.34-5.341z" />
    </svg>
);
